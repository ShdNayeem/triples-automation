...
// })->name('home');
Route::get('/update-user', [PaymentController::class,'update_user']);
...
Route::delete('remove-discount', [AutomationController::class, 'removeDiscount'])->name('remove-discount');
...
Route::get('allproducts/{orderId}', [PaymentController::class, 'allproducts'])->name('all-products');
