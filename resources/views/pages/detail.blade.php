                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="portfolio-details-slider swiper d-flex">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="container">
                                    <div class="carousel-container position-relative row border "
                                        style="border-color: #d5d9dd!important">
                                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner zoom-box">
                                                @foreach ($product->getMedia('product') as $index => $image)
                                                    <div class="carousel-item {{ $index == 0 ? 'active' : '' }}"
                                                        data-slide-number="{{ $index }}">
                                                        <div class="product-img--main d-block w-100" data-scale="2.2"
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <div class="row mx-0 justify-content-center">
                                                        @foreach ($product->getMedia('product') as $index => $image)
                                                            <div id="carousel-selector-{{ $index }}"
                                                                class="thumb col-4 col-sm-2 px-1 py-2 {{ $index == 0 ? 'selected' : '' }}"
                                    ...
                                    <ul class="nav nav-tabs nav-justified" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active" id="justified-tab-0" data-bs-toggle="tab"
                                                href="#justified-tabpanel-0" role="tab"
                                                aria-controls="justified-tabpanel-0" aria-selected="true">Product</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="justified-tab-1" data-bs-toggle="tab"
                                                href="#justified-tabpanel-1" role="tab"
                                                aria-controls="justified-tabpanel-1" aria-selected="false">Custom
                                                Solution</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content ProductDetailsTab" id="tab-content">
                                        <div class="tab-pane active" id="justified-tabpanel-0" role="tabpanel"
                                            ...
                                            <ul>
                                                ...
                                                <a class="btnProduct" id="add-to-cart"
                                                    href="{{ route('add-to-cart', $product->id) }}"
                                                    class="btn btn-primary cartbutton" onclick="myFunction()">Add to
                                                    Cart</a>
                                            </ul>
                                        </div>
                                        <div class="tab-pane" id="justified-tabpanel-1" role="tabpanel"
                                            aria-labelledby="justified-tab-1">
                                            <form action="{{ route('custom') }}" enctype="multipart/form-data"
                                                method="POST">
                                                @csrf
                                                ...
                                                {{-- Company Name --}}
                                                <div data-mdb-input-init class="form-outline mb-4">
                                                    <input type="text" id="form4Example9" class="form-control"
                                                ...
                                                <!-- Message input -->
                                                <div data-mdb-input-init class="form-outline mb-4">
                                                    <textarea class="form-control" id="form4Example3" placeholder="Please describe your requirements" name="message"
                                                ...
                                                <!-- Checkbox -->
                                                <div
                                                    class="form-check justify-content-center mb-4 checkbox-group required">
                                                    <div>
                                                        <input class="form-check-input me-2 " type="checkbox"
                                                            value="with Different Angle" id="form4Example4"
                                                            name="requirements[]" />
                                                    ...
                                                    <div>
                                                        <input class="form-check-input me-2" type="checkbox"
                                                            value="with Minor Changes" id="form4Example5"
                                                            name="requirements[]" />
                                                    ...
                                                    <div>
                                                        <input class="form-check-input me-2" type="checkbox"
                                                            value="with Specific Color" id="form4Example6"
                                                            name="requirements[]" />
                                                    ...
                                                    <div>
                                                        <input class="form-check-input me-2" type="checkbox"
                                                            value="in Common 3D Format" id="form4Example7"
                                                            name="requirements[]" />
                                                    ...
                                                    <div>
                                                        <input class="form-check-input me-2" type="checkbox"
                                                            value="in Common 3D Format with changes" id="form4Example8"
                                                            name="requirements[]" />
                                                ...
                                                <div class="mb-2">
                                                    <label for="formFileMultiple" class="form-label">Please Upload changes
                                                        as image file less than 2mb</label>
                                            ...
                                            <div class="help-block with-errors"></div>
                                                ...
                                                <button data-mdb-ripple-init type="submit"
                                                    class="btnProduct">Send</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <iframe width="100%" height="262" style="margin-top:1rem" src="https://www.youtube.com/embed/xDQTDKkSGgY?si=o4YrGphFqvPTjSbD" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        ...
                        <tbody>
                            @foreach ($product->component as $components)
                                ...
                                <tr>
                                    ...
                                    @foreach ($components->format as $index => $format)
                                        @if ($loop->last)
                                        {{-- {{ dd($index, $format, $loop->last) }} --}}
                                            <td>{{ $format->type }}</td>
                                        @endif
                                        {{-- @break --}}
                                    @endforeach
  ...
  <div class="row">
    <div class="col-md-12">
      <div id="relatedproducts" class="owl-carousel">
          @foreach($relatedProducts->take(12) as $relate)
        <div class="post-slide">
          <div class="post-img">
            <a href="{{ route('detail', $relate->slug) }}">{{$relate->getFirstMedia('product')}}</a>
          </div>
          <h3 class="post-title">
              <a  href="{{ route('detail', $relate->slug) }}">{{$relate->title}}</a>
            </h3>
          <div class="post-content">
            <a  href="{{ route('detail', $relate->slug) }}">{{$relate->subcategory->name}}</a>
          </div>
        </div>
        @endforeach
      </div>
