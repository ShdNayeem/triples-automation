...
<div class="inner-banner chilled" style="margin-top: 125px;">
    <h2 class="page-title">Chilled Water System</h2>
</div>
<section class="inner-page">
<div class="container d-flex flex-column text-center details">
    <h3 class="text-primary">Chilled Water System 3D Graphics for Building Automation Systems (BAS)</h3>
    <p class="text-secondary">Upgrade your BAS with the power of 3D! We offer top-of-the-line Chilled Water System (CWS) 3D graphics that revolutionize the way you interact with your building's cooling system. These 3D visuals provide an intuitive and user-friendly experience for facility managers and technicians.</p>
</div>
</section>
<section class="inner-page pt-0">
    <div class="container-fluid d-flex flex-column text-center text-secondary">
    <h2 class="inner-tag-section text-primary">Benefits of Our Chilled Water System<span>&nbsp;</span></h2>
    ...
    <div class="tagBox">
        ...
        <div class="tag-container shadow-lg">
            <h3>Cost Savings</h3>
            <h4>By optimizing system design and reducing errors, our Chilled Water System help you save on materials, labor, and long-term operational costs.</h4>
        </div>
    </div>
    <div class="tagBox">
...
<section class="inner-page pt-0">
    ...
    <div class="d-flex flex-column align-items-center">
        @foreach($chilledwatersystem as $chilledwater)
            <div class="floor-sample shadow-lg">
                @foreach($chilledwater->getMedia('chilledwatersystems') as $image)

                    <img loading="lazy" src="{{ $image->getUrl() }}" class="d-block w-100 img-fluid" alt="{{ $image->name }}">

                @endforeach
                <h2 class="pt-3 pb-2">{{ $chilledwater->title }}</h2>
            </div>
        @endforeach
    </div>
    </div>
...
<section class="inner-page enquiry-box">
    <div class="container-fluid d-flex flex-column text-center text-secondary">
