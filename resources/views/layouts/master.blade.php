...
<body>
    ...
    <!--        <img loading="lazy" src="assets/img/invitation-1.jpg" style="height:607px; width:1080px" alt="">-->
    <!--    <input onclick="handleButtonClick(this)" type="button" class="btn btn1" value="LAUNCH" />-->
    <!--        <input onclick="handleButtonClick(this)" type="button" class="btn btn2" value="LAUNCH" />-->
    <!--        <input onclick="handleButtonClick(this)" type="button" class="btn btn3" value="LAUNCH" />-->
    <!--    </div>-->
    <!--</div>-->
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function checkAndToggleDownloadLink(orderId) {
            ...
            downloadButton.forEach((download) => {
                ...
                if (downloadCompleted) {
                    download.innerText = 'Download Completed';
        ...
        elements.forEach((downloadButton, index) => {
            downloadButton.addEventListener('click', function(event) {
            // Retrieve the filename from data attribute
            var filename = downloadButton.getAttribute('data-filename');
            disableDownloadLink(event, filename, orderId, index);
            });
        });

        checkAndToggleDownloadLink(orderId);

        function disableDownloadLink(event, filename, orderId, index) {
            event.preventDefault();
...
$(document).ready(function() {
 ...
 <script>
        ...
        $("#recipeCarousel.carousel .carousel-item:first").addClass("active");
...
<script type="text/javascript">
    ...
    $('#contactUSForm').submit(function(event) {
        ...
        grecaptcha.ready(function() {
            ...
            grecaptcha.execute("{{ env('GOOGLE_RECAPTCHA_KEY') }}", {action: {{ route('contactMail') }} }).then(function(token) {
