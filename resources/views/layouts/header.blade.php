<!--======= Offers Section ======= -->
    <div class="offers-bar">
        <div class="marquee-content">
            ...
            @foreach($automationOffers as $offer)
...
<!-- ======= Header ======= -->
<header id="header" class="header fixed-top p-3" style="z-index: 1050; margin-top: 30px;margin-bottom: 30px;">
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li class="dropdown"><a class="nav-link scrollto" href="/category"><span>Services</span> <i
                    ...
                    <ul>
                        @foreach($categories as $category)
                            ...
                            <li>
                                <a href="{{ route('subcategory', ['slug' => $category->slug]) }}">{{$category->name}}</a>
                            </li>
                            @endif
                ...
                <li><a class="nav-link scrollto" href="{{ url('wishlist') }}"> <button class="btn" style="color: #012970;; font-weight:bold;"> Wishlist </button></a></li>
