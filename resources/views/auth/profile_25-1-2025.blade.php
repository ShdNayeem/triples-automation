                        ...
                        <div class="card-body">
                            <form action="{{ route('update') }}" method="POST">
                                    ...
                                    <div class="col">
                                        <div class="form-outline">
                                            ...
                                            <input type="text" id="form7Example1" name="name"
                                                value="@if(Auth::guard('customer')->check())
                                                {{ Auth::guard('customer')->user()->name }}
                                                @elseif(Auth::guard('web')->check())
                                                {{ Auth::guard('web')->user()->name }}
                                                @endif" readonly class="form-control"
                                                autocomplete="off" />
                                ...
                                <div class="row mb-4">
                                    <div class="col">
                                        <div class="form-outline">
                                            ...
                                            value="{{ optional($address)->door_no }}"  class="form-control" readonly  required />
                                    ...
                                    <div class="col">
                                        <div class="form-outline">
                                            <input type="textarea" id="form7Example4" name="street" class="form-control" readonly
                                            value="{{ optional($address)->street }}"   required />
                                ...
                                <div class="row mb-4">
                                    <div class="col">
                                        <div class="form-outline">
                                            <input type="number" id="form7Example5" name="pincode" class="form-control" readonly
                                            value="{{ optional($address)->pincode }}"     required />
                                    ...
                                    <div class="col">
                                        <div class="form-outline">
                                            <input type="text" id="form7Example6" name="area" class="form-control" readonly
                                            value="{{ optional($address)->area }}"     required />
                                ...
                                <div class="row mb-4">
                                    <div class="col">
                                        <div class="form-outline">
                                            <input type="text" id="form7Example7" name="city" class="form-control" readonly
                                            value="{{ optional($address)->city }}"  required />
                                    ...
                                    <div class="col">
                                        <div class="form-outline">
                                            <input type="text" id="form7Example8" name="state" class="form-control" readonly
                                            value="{{ optional($address)->state }}"   required />
                                ...
                                <div class="row mb-4">
                                    <div class="col">
                                        <div class="form-outline">
                                            <input type="text" id="form7Example9" name="country" class="form-control" readonly
                                            value="{{ optional($address)->country }}"   required autocomplete="on" />
                                    ...
                                    @endif"  readonly class="form-control" autocomplete="off" />
