                        ...
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="container">
                              <div class="carousel-container position-relative row border " style="border-color: #d5d9dd!important" >
                                  ...
                                  <!-- Carousel Navigation -->
                                  <div id="carousel-thumbs" class="carousel slide" data-ride="carousel" style="display: none;">
...
<div class="tab-content ProductDetailsTab" id="tab-content">
  ...
  <form action="{{ route('custom') }}"  enctype="multipart/form-data" method="POST">
                    ...
                    <iframe width="100%" height="250" style="margin-top:1rem" src="https://www.youtube.com/embed/DZR7B9GRp4g?si=Lq-GZbjeTmdAnkge" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            </div>
            <div>
